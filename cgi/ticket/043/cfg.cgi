...
$admin_email = 'info@geki-curry.com';	# 管理者メールアドレス
					# お客様に通知されます。
$send_email = 'geki-curry@gmail.com';	# 上以外の送付先メールアドレス、客への通知なし
					# 複数設定するときはカンマ(,)でくぎる
...
$csvd = './____log____/';	# 1の場合必要。申込ログ格納場所のパス
...
$VLINK   = '#FF0000';	# VLINK色
$ALINK   = '#00FF00';	# ALINK色
$BASURL  = 'http://geki-curry.com/';	# あなたのHPのアドレス
