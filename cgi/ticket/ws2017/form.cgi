...
sub HtmlEnd {
	...
	print "参加者氏名（カタカナ･フルネーム）<input type=text size=30 name=\"name\"><br>\n";
	print "年齢<input type=text size=3 name=\"age\">歳<br>\n";
	print "E-Mail<input type=text size=30 name=\"email\"><br>\n";
